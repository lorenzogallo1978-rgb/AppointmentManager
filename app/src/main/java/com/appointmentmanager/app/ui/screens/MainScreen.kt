...
private fun AppointmentCard(
    ...
    val containerColor = getCardContainerColor(daysRemaining, isDarkTheme)
    val contentColor = getCardContentColor(daysRemaining, isDarkTheme)
...
private fun getCardContainerColor(daysRemaining: Long, isDark: Boolean): Color {
    return when {
        daysRemaining < 0 -> if (isDark) Color(0xFF3E3E3E) else Color(0xFFE0E0E0)
        daysRemaining in 0..1 -> if (isDark) Color(0xFF5C1D1D) else Color(0xFFFFD1D1)
        daysRemaining == 2L -> if (isDark) Color(0xFF5C4314) else Color(0xFFFFE5B4)
        else -> if (isDark) Color(0xFF1B432C) else Color(0xFFD4EEDD)
    }
}

private fun getCardContentColor(daysRemaining: Long, isDark: Boolean): Color {
    return when {
        daysRemaining < 0 -> if (isDark) Color(0xFFCCCCCC) else Color(0xFF424242)
        daysRemaining in 0..1 -> if (isDark) Color(0xFFFFB4AB) else Color(0xFF93000A)
        daysRemaining == 2L -> if (isDark) Color(0xFFFFDCBE) else Color(0xFF8A5100)
        else -> if (isDark) Color(0xFFA6E3BC) else Color(0xFF00522B)
    }
}
